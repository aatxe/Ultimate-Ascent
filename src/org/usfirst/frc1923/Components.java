...
public final class Components {
	...
	public static final DriveComponent robotDrive = new DriveComponent(new MotorGroup(new Victor(1), new Victor(3)), new MotorGroup(new Victor(2), new Victor(4)));
	...
	public static final ShooterComponent shooter = new ShooterComponent(new MotorGroup(new Jaguar(1),new Jaguar(2)), new MotorGroup(new Jaguar(3), new Jaguar(4)));
